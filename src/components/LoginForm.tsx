...
export function LoginForm() {
  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="space-y-4">
      ...
      <GuestButton
        onError={setError}
        className="inline-flex w-full items-center justify-center rounded-xl border border-mist-300 bg-mist-50 px-5 py-3 text-base font-semibold text-ink-900 transition-colors hover:bg-mist-100 disabled:cursor-not-allowed disabled:opacity-60"
      />
