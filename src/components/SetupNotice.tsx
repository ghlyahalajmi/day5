...
export function SetupNotice() {
  return (
    <div className="mx-auto w-full max-w-lg rounded-2xl border border-mist-300 bg-mist-50 p-6 text-sm text-ink-700 shadow-sm">
      ...
      <p className="mt-2">
        ...
        <code className="rounded bg-mist-200 px-1.5 py-0.5 text-xs">.env.local</code> (or to your
